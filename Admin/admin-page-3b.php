...
<body>
  ...
  <!-- Form -->
  <div class="container">
    <h1> Tambah Detail Program Studi </h1>


          <form>
            <label for="level"><p>Level</p></label>
              <input type="text" id="level" name="level" placeholder="Input level">
    ...
    <form action = "tambah_detail_ps.php" method="post" enctype="multipart/form-data">
      ...
      ?>
          ...
          <label for="namalengkap"><p>NIP</p></label>
            <input type="text" id="namalengkap" name="nip" placeholder="Input NIP " maxlength="18">

            <label for="nip"><p>Nama Lengkap</p></label>
              <input type="text" id="nip" name="nama"  placeholder="Input nama Lengkap">
        ...
        <label for="fakultas"><p>Fakultas</p></label>
          ...
          <label for="jurusan"><p>Jurusan</p></label>
            ...
            <label for="prodi"><p>Pogram Studi</p></label>
              ...
              <pre><input type="file" value="Upload foto" name="foto"></pre>
              <!-- codena ku tth ae yah tebisa hehe-->
              <br>
              <input type="submit" value="Submit" name="tambah" accept="image/*">
            </form>
          </div>
