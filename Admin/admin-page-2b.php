...
<body>
  ...
  <div class="container">
    ...
    <form action="tambah_jurusan.php" method="POST">
      ...
      <label for="kodejurusan"><p>Kode Jurusan</p></label>
        <input type="text" id="kodejurusan" name="kode_jur" placeholder="Input kode jurusan">

        <label for="namajurusan"><p>Nama Jurusan</p></label>
          <input type="text" id="namajurusan" name="nama_jur" placeholder="Input nama jurusan">

            <label for="kodefakultas"><p>Fakultas</p></label>
              <select id="level" name="nama_fak">
